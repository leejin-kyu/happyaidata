...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      {/* 히어로 섹션 - 심플한 컬러 */}
      <section className="relative bg-gradient-to-br from-slate-50 via-indigo-50/20 to-slate-50 dark:from-slate-950 dark:via-indigo-950/20 dark:to-slate-950 py-16 sm:py-24 md:py-40 lg:py-48 overflow-hidden">
        {/* AI 신경망 배경 패턴 - 은은하게 */}
          ...
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="neural-network" x="0" y="0" width="200" height="200" patternUnits="userSpaceOnUse">
                <circle cx="20" cy="20" r="2" fill="rgb(99, 102, 241)" opacity="0.4"/>
                <circle cx="100" cy="40" r="2.5" fill="rgb(168, 85, 247)" opacity="0.4"/>
                <circle cx="180" cy="30" r="2" fill="rgb(236, 72, 153)" opacity="0.4"/>
                <circle cx="60" cy="100" r="2.5" fill="rgb(99, 102, 241)" opacity="0.4"/>
                <circle cx="140" cy="120" r="2" fill="rgb(168, 85, 247)" opacity="0.4"/>
                <circle cx="40" cy="180" r="2.5" fill="rgb(236, 72, 153)" opacity="0.4"/>
                <circle cx="160" cy="170" r="2" fill="rgb(99, 102, 241)" opacity="0.4"/>
                <line x1="20" y1="20" x2="100" y2="40" stroke="rgb(99, 102, 241)" strokeWidth="0.3" opacity="0.15"/>
                <line x1="100" y1="40" x2="180" y2="30" stroke="rgb(168, 85, 247)" strokeWidth="0.3" opacity="0.15"/>
                <line x1="20" y1="20" x2="60" y2="100" stroke="rgb(236, 72, 153)" strokeWidth="0.3" opacity="0.15"/>
                <line x1="100" y1="40" x2="140" y2="120" stroke="rgb(99, 102, 241)" strokeWidth="0.3" opacity="0.15"/>
                <line x1="60" y1="100" x2="140" y2="120" stroke="rgb(168, 85, 247)" strokeWidth="0.3" opacity="0.15"/>
                <line x1="60" y1="100" x2="40" y2="180" stroke="rgb(236, 72, 153)" strokeWidth="0.3" opacity="0.15"/>
                <line x1="140" y1="120" x2="160" y2="170" stroke="rgb(99, 102, 241)" strokeWidth="0.3" opacity="0.15"/>
              </pattern>
            </defs>
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center">
            <div className="animate-fade-in">
              <div className="mb-6 sm:mb-10">
                <span className="inline-block text-xs sm:text-sm font-bold px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-indigo-500 to-violet-600 text-white rounded-full tracking-wider uppercase shadow-md">
                  {home.hero.badge}
                </span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <Link
                  ...
                  className="group inline-flex items-center justify-center px-6 sm:px-8 md:px-10 py-3 sm:py-3.5 md:py-4 text-sm sm:text-base font-bold text-white bg-gradient-to-r from-indigo-600 via-violet-600 to-fuchsia-600 hover:from-indigo-700 hover:via-violet-700 hover:to-fuchsia-700 transition-all rounded-full shadow-lg hover:shadow-xl hover:scale-105 transform duration-300"
                >
                ...
                <Link
                  ...
                  className="group inline-flex items-center justify-center px-6 sm:px-8 md:px-10 py-3 sm:py-3.5 md:py-4 text-sm sm:text-base font-bold text-indigo-600 dark:text-indigo-400 bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm border-2 border-indigo-600 dark:border-indigo-400 hover:bg-indigo-50 dark:hover:bg-slate-700 transition-all rounded-full shadow-md hover:shadow-lg hover:scale-105 transform duration-300"
                >
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-6">
                {home.hero.stats.map((stat, index) => (
                  <div
                    ...
                    className={
                      index % 3 === 0
                        ? "relative bg-gradient-to-br from-indigo-600 via-violet-600 to-fuchsia-600 p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 transform overflow-hidden group"
                        : "relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl shadow-md border border-slate-200 dark:border-slate-700 hover:shadow-lg hover:border-indigo-200 dark:hover:border-indigo-600 hover:scale-105 transition-all duration-300 transform group"
                    }
                  >
                    <div
                      className={
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
            {home.solutions.items.map((solution, index) => (
              <div
                key={index}
                className="group relative bg-white dark:bg-slate-800 p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl shadow-md hover:shadow-lg transition-all duration-300 border border-slate-200 dark:border-slate-700 hover:border-indigo-200 dark:hover:border-indigo-600 hover:-translate-y-1 transform overflow-hidden"
              >
                <div className="relative mb-6">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-br from-indigo-600 via-violet-600 to-fuchsia-600 rounded-2xl flex items-center justify-center mb-4 sm:mb-6 shadow-md group-hover:scale-105 transition-all duration-300">
                ...
                <ul className="relative space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                  {solution.features.map((feature, idx) => (
                    <li key={idx} className="flex items-start">
                      <span className="text-indigo-600 dark:text-indigo-400 font-bold mr-2 sm:mr-3 text-lg">→</span>
                ...
                <Link
                  href={solution.link}
                  className="relative inline-flex items-center text-indigo-600 dark:text-indigo-400 hover:text-violet-600 dark:hover:text-violet-400 font-bold text-base sm:text-lg transition-all group/link"
                >
                  {solution.linkText}
      ...
      {/* 기술 스택 */}
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-br from-slate-50 to-indigo-50/20 dark:from-slate-950 dark:to-indigo-950/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12 sm:mb-16 md:mb-20 text-center">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 dark:text-white mb-4 sm:mb-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 sm:gap-5 md:gap-6">
            {home.techStack.technologies.map((tech, index) => (
              ...
              >
                <div className="relative text-2xl sm:text-3xl md:text-4xl font-black bg-gradient-to-r from-indigo-600 via-violet-600 to-fuchsia-600 dark:from-indigo-400 dark:via-violet-400 dark:to-fuchsia-400 bg-clip-text text-transparent mb-1 sm:mb-2 group-hover:scale-105 transition-transform">
                  {tech.name}
                </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 text-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-10 w-96 h-96 bg-indigo-500 rounded-full mix-blend-screen filter blur-3xl"></div>
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-violet-500 rounded-full mix-blend-screen filter blur-3xl"></div>
        </div>
              ...
              <div
                ...
                className={
                  index === 1
                    ...
                    : "bg-gradient-to-br from-indigo-600 via-violet-600 to-fuchsia-600 p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 transform relative overflow-hidden group"
                }
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
            {home.content.items.map((item, index) => (
              <div
                key={index}
                className="group bg-white dark:bg-slate-800 p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl shadow-md hover:shadow-lg transition-all duration-300 border border-slate-200 dark:border-slate-700 hover:border-indigo-200 dark:hover:border-indigo-600 hover:-translate-y-1 transform"
              >
                ...
                <a
                  ...
                  className={
                    item.type === "YouTube"
                      ? "inline-flex items-center justify-center w-full bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 text-white font-bold py-3 sm:py-4 px-4 sm:px-6 rounded-xl shadow-md hover:shadow-lg transition-all hover:scale-105 transform text-sm sm:text-base"
                      : "inline-flex items-center justify-center w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-bold py-3 sm:py-4 px-4 sm:px-6 rounded-xl shadow-md hover:shadow-lg transition-all hover:scale-105 transform text-sm sm:text-base"
                  }
                >
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            {home.cta.buttons.map((button, index) => (
              <Link
                ...
                className={
                  button.primary
                    ? "inline-flex items-center justify-center px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-5 text-base sm:text-lg font-black text-indigo-600 bg-white hover:bg-indigo-50 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all transform"
